...
class AppStore extends Component {
  ...
  render() {
    ...
    const filteredAppListFromCategory = appsList.filter(
      eachApp => eachApp.category === activeCategory,
    )
    
     const finalFilteredAppList=filteredAppListFromCategory.filter(eachApp=>
    ...
    return (
      <div className="bg-container">
        ...
        <div className="search-container">
          <input type="search" className="search-input" placeholder="search" onChange={this.onChangeInput}/>
          <img
        ...
        <ul className="tabItem-container">
          {tabsList.map(eachTab => (
            <TabItem
              ...
              isActive={activeCategory === eachTab.tabId}
            />
          ))}
        </ul>
        <ul className="appItem-container">
          {finalFilteredAppList.map(eachApp => (
